...
with
      ...
      (
        select
          ...
          med.icms_int_pct / 100												intr_icms_rt, --D19 = D41
          ...
          med.pcm_red_pct/100													pmpf_prc_amt, --D39
          0																	cst_cd,
      ...
      (
        select
          ...
          pcm_prc_amt - (pcm_prc_amt * pmpf_prc_amt)																		prod_ref_price_amt
        --D40
      ...
      (
        select
          cte_med_st_4.*,
          prod_ref_price_amt * intr_icms_rt																						st_db
        --D42
        from cte_med_st_4
      ),
      cte_med_st_6
      ...
      (
        select
          cte_med_st_6.*,
          fnal_purchase_price_amt * taxa_ba																						taxa_st, --D46
          pcm_prc_amt * min_pmc																									min_pmc_st
        --D48
        from cte_med_st_6
      ),
      cte_med_st_8
      ...
      (
        select
          cte_med_st_7.*,
          if(taxa_st > min_pmc_st, taxa_st, min_pmc_st)																			st_prc_2
        --D49
        from cte_med_st_7
      ),
      cte_med_st_9
