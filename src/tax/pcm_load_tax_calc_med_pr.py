 ...
 WITH
      ...
      (
        select
          ...
          med.icms_int_pct													intr_icms_rt, --D19 = D47 -- Diferente para RJ
      ...
      (
        ...
        SELECT med_tran.*,
          ...
          --	if(cst_cd in (0, 4, 5, 6, 7), --si = Nacional | no Importado
          --		0.12, 
          --		0.04
          --	)
      ...
      (
        ...
        --D43 Ojo con SC. hasta acá revisado ok		
        from cte_med_st_3
      ),
      cte_med_st_5
      AS
      ...
      (
        select cte_med_st_5.*,
          ...
          if(pcm_prc_amt = 0,
        mva_calc,
        --prod_ref_price_amt corretion 15-09-2021
        reduced_pmc
      )																														calc_st
        --D46
        from cte_med_st_5
      ...
      (
        select cte_med_st_7.*,
          ...
          if(icms_typ_cd = 2 and trans_is_intra_st_ind = 1, 
        0, 
        if(calc_st = prod_ref_price_amt and (st_db - icms_own_amt) < (pcm_prc_amt * 0.056),
          pcm_prc_amt * 0.056, 
          if(icms_own_amt > st_db,
            0,
            st_db - icms_own_amt
