    ...
    WITH
      ...
      (
        select
          ...
          med.mva_7_pct,
          med.mva_4_pct,
          med.mva_orig_pct/100												mva_orig_pct, --D42
          dprod.pck_is_medcn_ind,
          med.red_mva_pct/100													red_mva_pct,
      ...
      (
        select cte_med_st_3.*,
          ...
          pcm_prc_amt - (pcm_prc_amt *pcm_red_pct)																		reduced_pmc
        --D40 
      ...
      (
        select cte_med_st_4.*,
          --fnal_purchase_price_amt * (1 + mva_adj)	* (1 - red_mva) 																mva_calc			--D45 CHANGE
          fnal_purchase_price_amt * (1 + mva_orig_pct)																				mva_calc
        --D45 CHANGE
        from cte_med_st_4
      ),
      cte_med_st_6
