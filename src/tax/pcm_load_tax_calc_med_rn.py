...
WITH
      ...
      (
        select
          ...
          med.icms_int_pct													intr_icms_rt, --D19 = D51
          trans.trans_is_intra_st_ind											trans_is_intra_st_ind, --D20 1 = interna | 0 = interestadual
          ...
          med.red_mva_pct/100													reductor_mva, --D44			
          med.mva_12_pct,
          med.mva_7_pct,
          med.mva_4_pct,
      ...
      (
        ...
        --D22
        --reductor_mva * ( 1 - intr_icms_rt ) / ( 1 -  trans_icms_rt)														trava_adjusted_rt	
        FROM cte_med_st_2
      ),
      cte_med_st_4
      AS
      ...
      (
        select cte_med_st_3.*,
          ...
          --(pmpf_prc_amt * trava_adjusted_rt)																				trava_amt,
      ...
      (
        select cte_med_st_4.*,
          fnal_purchase_price_amt * (1 + mva_adj) * (1 - reductor_mva)															mva_calc, --D45
          fnal_purchase_price_amt * (taxa_rn)																						st_taxa_rn
        --D48
        from cte_med_st_4
      ),
      cte_med_st_6
     ...
     select cte_med_st_6.*,
      ...
      (
        ...
        if(seller_is_manuf_ind= 0 and trans_is_intra_st_ind= 1,
          0, 
          calc_st * intr_icms_rt/100))																						st_db
        --D52
        from cte_med_st_7
      ),
      cte_med_st_9
